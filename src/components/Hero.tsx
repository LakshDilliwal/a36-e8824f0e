...
const Hero = () => (
  <section className="min-h-[64vh] md:min-h-[85vh] flex items-center bg-background relative overflow-hidden a36-hero-glow a36-tick-corners a36-tick-corners-charcoal">
