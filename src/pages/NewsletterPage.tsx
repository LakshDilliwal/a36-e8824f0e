...
const features = [
  ...
  { title: "Opportunity Alerts", body: "Upcoming A36 Labs events and partner events globally" },
  { title: "Event Previews", body: "Stay ahead with curated alpha and ecosystem moves" },
];
