    ...
    <section className="bg-background py-24">
      <div className="container max-w-5xl mx-auto px-6 md:px-16">
        ...
        <p className="text-base text-primary/70 mt-6 max-w-[560px]">
          Real work from real ecosystems. Bounties, grants, and builder opportunities<br />curated by A36 Labs
        </p>

        <div className="mt-10 max-w-[480px]">
          <p className="text-sm text-primary/60 mb-3">Stay updated<br />get notified when we launch:</p>
          <iframe
